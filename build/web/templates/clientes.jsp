<div class="container">
    <h2 class="header center blue-text">Clientes</h2>
    <div id="cuadro2">
...
<script>
    ...
    function eliminar() {
        $("#eliminar-usuario").on("click", function () {
            var cod_cliente = $("#frmEliminarUsuario #cod_cliente").val(),
            ...
            $.ajax({
                method: "POST",
                url: "<%= request.getContextPath()%>/ControlServlet?parAccion=guardarCliente",
                data: {"cod_cliente": cod_cliente, "opcion": opcion}
            }).done(function (info) {
                console.log(info);
                var json_info = JSON.parse(info);
                mostrar_mensaje(json_info);
    ...
    function listar() {
        ...
        var table = $("#dt_cliente").DataTable({
            ...
            "ajax": {
                "method": "POST",
                "url": "<%= request.getContextPath()%>/ControlServlet?parAccion=listaCliente"
            },
            "columns": [
                {"defaultContent": ""},
                {"data": "dni"},
    ...
    function obtener_id_eliminar(table) {
        ...
        $("#btnBorrar").on("click", function () {
            ...
            if (data != null) {
                console.log(data);
                $("#frmEliminarUsuario #cod_cliente").val(data.cod_cliente);
